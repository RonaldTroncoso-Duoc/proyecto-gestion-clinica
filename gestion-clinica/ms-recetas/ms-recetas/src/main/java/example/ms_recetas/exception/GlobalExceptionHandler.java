...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleRecetaNotFound(RecetaNotFoundException ex) {
        log.warn("Receta no encontrada: {}", ex.getMessage());
        return buildResponse(ex.getMessage(), HttpStatus.NOT_FOUND, "Receta No Encontrada");
    }
    ...
    public ResponseEntity<Object> handleFeignNotFound(FeignException.NotFound ex) {
        ...
        return buildResponse(
                "Ficha clínica, paciente o médico no encontrado en el sistema",
