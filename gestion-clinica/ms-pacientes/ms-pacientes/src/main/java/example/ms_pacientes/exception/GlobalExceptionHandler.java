...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handlePacienteNotFound(PacienteNotFoundException ex) {
        log.warn("Paciente no encontrado: {}", ex.getMessage());
        return buildResponse(ex.getMessage(), HttpStatus.NOT_FOUND, "Paciente No Encontrado");
    }
